<nav class="sidebar" id="sidebar">
    <div class="brand-logo">
        ...
        <div>
            <h6 class="fw-bold mb-0" data-i18n="brand">TrainEd</h6>
            <small class="text-muted" data-i18n="platform">Training Platform</small>
        </div>
    </div>
