...
const menuSections = computed(() => {
  ...
  const menus = {
    ...
    student: userState.is_in_jisr
      ...
      : (userState.skill_test_required && !userState.skill_test_passed
          ? [
              {
                title: 'menu',
                items: [
...
=======
          { path: '/company/trello-settings', icon: 'bi bi-kanban', key: 'trello_settings', label: 'Trello' },
>>>>>>> Stashed changes
